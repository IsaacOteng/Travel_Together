  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-[200] h-[52px] rounded-full
        bg-gradient-to-br from-[var(--tt-accent)] to-[#ff8c5a] border-none cursor-pointer
    ...
    >
      ...
      <span className={`text-[13px] font-bold text-ink whitespace-nowrap transition-opacity duration-150 ${hov ? "opacity-100" : "opacity-0"}`}>
        Create trip
      </span>
    </button>
  );
